...
| | |
|---|---|
| **[English](en/README.md)** | Full guide: installation, user & admin manuals, operations |
| **[Русский](ru/README.md)** | Полное руководство: установка, пользователь и администратор, эксплуатация |
...
| English | Русский |
|---------|---------|
| [Installation](en/installation/README.md) | [Установка](ru/installation/README.md) |
| [Quick start](en/getting-started/README.md) | [Быстрый старт](ru/getting-started/README.md) |
| [User guide](en/user/README.md) | [Руководство пользователя](ru/user/README.md) |
